...
impl<DT: DrawTarget<Color = Rgb565, Error = E>, E: Debug> SettingScreen<DT, E> {
    ...
    pub fn draw(&self, display: &mut DT) {
        ...
        write!(text, "{:02}", self.fans.items[0].0).unwrap();
        ...
        write!(text, "{:03}", self.fans.items[1].0).unwrap();
        ...
        let mut text: String<2> = String::new();
        write!(text, "{:02}", self.fans.items[2].0).unwrap();
        ...
        let mut text: String<3> = String::new();
        write!(text, "{:03}", self.fans.items[3].0).unwrap();
        ...
        let mut text: String<2> = String::new();
        write!(text, "{:02}", self.fans.items[4].0).unwrap();
        ...
        let mut text: String<3> = String::new();
        write!(text, "{:03}", self.fans.items[5].0).unwrap();
        ...
        let mut text: String<2> = String::new();
        write!(text, "{:02}", self.fans.items[6].0).unwrap();
        ...
        let mut text: String<3> = String::new();
        write!(text, "{:03}", self.fans.items[7].0).unwrap();
